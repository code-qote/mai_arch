...
std::string CancelBookingHandler::HandleRequest(
    ...
    try {
        ...
        auto booking_result = db_.GetBooking(cancel_request.booking_id);
        ...
        auto update_result = db_.UpdateBookingStatus(booking.id, common::database::BookingStatus::kCancelled);
